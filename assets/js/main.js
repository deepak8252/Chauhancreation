! function(e) {
    ...
    }, e(".testi-card-tab").length && e(".testi-card-tab").thTab({
        sliderTab: !0,
        tabButton: ".tab-btn"
...
$('.more-button').click(function () {
    $('.DisNone').slideToggle();
    if ($('.more-button').text() == "Less Locations") {
        $(this).text("More Location")
    } else {
        $(this).text("Less Locations")
    }
});

// read more js code or less more
function myFunction() {
    ...
    if (dots.style.display === "none") {
      ...
      btnText.innerHTML = "more location"; 
      moreText.style.display = "none";
    } else {
      dots.style.display = "none";
      btnText.innerHTML = " less location"; 
